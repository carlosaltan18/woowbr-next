...
import { BrandWaze, BrandWhatsapp } from 'tabler-icons-react';
...
export function InvitacionBodaEstandar() {
...
useEffect(() => {
    ...
    return (
        ...
        >
            ...
            {/* Sección 6 */}
            <div className="w-full min-h-[60rem] md:h-[75rem] lg:h-[75rem] flex flex-col items-center justify-center text-center bg-[#ffff] text-black">
                ...
                <div id="formulario-asistencia" className="w-full py-10 px-4 text-center bg-[#FFFF] text-black">
                    ...
                    >
                        <BrandWhatsapp
                            size={48}
                            className="text-green-500 hover:text-green-600 transition duration-300 mx-auto"
                        />
                    </a>
                </div>
            </div>
            ...
            <div className="w-full min-h-[50rem] md:h-[70vh] lg:h-[85rem] flex flex-col items-center justify-center text-center bg-[#4c6454] text-white">
                <Image src={calendario} alt="Logo" width={150} height={60} className="mb-6 mx-auto w-16 sm:w-16 md:w-25 lg:w-25 h-auto mt-14" />
